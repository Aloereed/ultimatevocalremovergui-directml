# Ultimate Vocal Remover GUI v5.5.0 with DirectML
...
## Issues
+ MDX-Net might fall back to CPU.
+ Demucs is not allowed due to "Invalid or unsupported data type." in Torch-DirectML.
...
- Download the original UVR installer for Windows via the link below:
