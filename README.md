...
As of the current version (v5.6), AMD and Intel graphics cards are officially supported, go here [download](https://github.com/Anjok07/ultimatevocalremovergui/releases/download/v5.6/UVR_v5.6.0_setup_opencl.exe).  
